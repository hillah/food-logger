...
fun NutritionBarChartSection(
    ...
    val items = listOf(
        ...
        createNutrientItem("ビタミンB1", nutrients.vitaminB1Mg, targets.targetVitaminB1Mg, "mg", canBeExcessive = false, lowRatio = 0.80),
        createNutrientItem("ビタミンB2", nutrients.vitaminB2Mg, targets.targetVitaminB2Mg, "mg", canBeExcessive = false, lowRatio = 0.80),
